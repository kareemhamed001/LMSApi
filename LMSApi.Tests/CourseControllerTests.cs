...
namespace LMSApi.Tests
{
    public class CourseControllerTests
    {
        ...
        [Fact]
        public async Task GetById_WhenCourseNotExists_ReturnsNotFoundResult()
        {
            // Arrange
            int courseId = 1;

            _mockCourseService.Setup(x => x.GetByIdAsync(courseId)).ReturnsAsync((Course)null);
        ...
        public async Task Add_WhenValidRequest_ReturnsCreatedResult()
        {
            ...
            Assert.Equal(courseRequest, apiResponse.Data);
        }
