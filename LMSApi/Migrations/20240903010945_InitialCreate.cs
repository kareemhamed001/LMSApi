        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteName = table.Column<string>(type: "nvarchar(100)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassTranslations_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassTranslations_Languages_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassTranslations_ClassId",
                table: "ClassTranslations",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassTranslations_LanguageId",
                table: "ClassTranslations",
                column: "LanguageId");
